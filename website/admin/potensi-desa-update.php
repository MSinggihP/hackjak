<?php   
    ...
    $post = $mysqli->query("SELECT * from potensi where id=4");
...
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-success alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Berhasil! </strong> Data sudah diedit.
                        </div>
                    </div>
                </div>
                <?php } ?>
    ...
    ?>  
                <div class="row">
                    <div class="col-lg-10">
     <form method="post" enctype="multipart/form-data" class="form-horizontal" action="?tampil=edit-potensi-sda">
