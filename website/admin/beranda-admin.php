<?php 
    ...
    $cek_jum_kes    = $mysqli->query("SELECT count(*) as jumlah from puskesmas where features_properties_nama_Puskesmas >= 0");
    $data_jum_kes  = $cek_jum_kes->fetch_array();
    $cek_jum_user    = $mysqli->query("SELECT count(*) as jumlah from users where level_id=3");
    $data_jum_user  = $cek_jum_user->fetch_array();
    $cek_jum_antrian    = $mysqli->query("SELECT count(*) as jumlah from antrian");
    $data_jum_antrian  = $cek_jum_antrian->fetch_array();
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Hi! <?php echo $data['nama'] ?> </strong> Selamat Datang, di Puskesmas Tiket Digital
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $data_jum_user['jumlah']; ?></div>
                                        <div>Pengguna</div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $data_jum_kes['jumlah'] ?></div>
                                        <div>Puskesmas</div>
                                    </div>
                                </div>
                            </div>
                            <a href="?tampil=puskesmas">
                                <div class="panel-footer">
                                    <span class="pull-left">View Details</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                        ...
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        <div class="huge"><?php echo $data_jum_antrian['jumlah'] ?></div>
                                        <div>Antrian</div>
                                    </div>
                                </div>
                            </div>
