<?php   
    ...
    {   date_default_timezone_set("Asia/Jakarta");
        ...
        if(!isset($errMSG))
        {
        $mysqli->query("INSERT INTO struktur set
                nama = '$_POST[nama]',
                gambar = '$userpic',
            ...
            ") or die($mysqli->error);
        $tambah = true;
        echo"<meta http-equiv='refresh' content='1; url=?tampil=tentang'>";
    }
    }
 ?>
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-success alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Berhasil! </strong> Data sudah diposting. Silakan tunggu...
                        </div>
                    </div>
                </div>
                <?php } ?>
    ...
    <tr>
        ...
        <td><input class="form-control" type="text" name="urut" placeholder="Urut" /></td>
    </tr>
    <tr>
        <td><label class="control-label">Jabatan</label></td>
        <td><input class="form-control" type="text" name="jabatan" placeholder="Jabatan" /></td>
    </tr>
    <tr>
    ...
    <td><label class="control-label">Deskripsi</label></td>
        <td><textarea name="deskripsi" class="form-control" rows="3"></textarea></td>
    </tr>
    ...
    <tr>
        ...
        <a href="?tampil=tambah-struktur" class="btn btn-default">Reset</a>
        </td>
    </tr>
