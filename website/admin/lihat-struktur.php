...
<div id="page-wrapper">
    ...
    ?>  
                <div class="row">
                    <div class="col-lg-10">
     <form method="post" enctype="multipart/form-data" class="form-horizontal" action="?tampil=edit-struktur&id=<?php echo $lihat['id']; ?>">
        
    <table class="table table-bordered table-responsive">
    
    <tr>
        <td><label class="control-label">Urut</label></td>
        <td> <?php echo $lihat['urut']; ?></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td style="text-align: justify;"> <?php echo $lihat['deskripsi']; ?></td>
    </tr>
