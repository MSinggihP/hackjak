<?php   
    ...
    {   
        ...
        if(!isset($errMSG))
        {
        $mysqli->query("INSERT INTO slider set
                nama = '$_POST[judul]',
                gambar = '$userpic',
                isi = '$_POST[isi]',
                detail = '$_POST[detail]'
            ") or die($mysqli->error);
        $tambah = true;
        echo"<meta http-equiv='refresh' content='1; url=?tampil=slider'>";
    }
    }
 ?>
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-success alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Berhasil! </strong> Slider sudah diposting. Silakan tunggu...
                        </div>
                    </div>
                </div>
                <?php } ?>
    ...
    <tr>
        ...
        <tr>
        <td><label style="text-align: left;" class="control-label">Gambar <br><em><p style="color:red">Diutamakan ukuran 1600 x 550</p></em></label></td>
    ...
    <tr>
        ...
        <td><textarea name="detail" class="form-control" rows="3"></textarea></td>
    </tr>
