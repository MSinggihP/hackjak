<?php   
    ...
    $post = $mysqli->query("SELECT * from potensi where id='$_GET[id]' AND type='desa'");
...
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Potensi Desa
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Berhasil! </strong> Artikel sudah diposting.
                        </div>
                    </div>
                </div>
                <?php } ?>
    ...
    ?>  
                <div class="row">
                    <div class="col-lg-10">
     <form method="post" enctype="multipart/form-data" class="form-horizontal" action="?tampil=edit-potensi-desa&id=<?php echo $lihat['id']; ?>">
