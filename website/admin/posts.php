 ...
 ?>       
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-6">
                         <p><a href="?tampil=tambah-post" class="btn btn-primary btn-md" role="button">Tambah</a>
                         </p>
                    </div>
                    <div class="col-lg-6">
        ...
        // jika kotak pencarian tidak sama dengan kosong
            if($input_cari != "") {
                ...
                ORDER BY nama ASC")or die($mysqli->error);
                    ...
                    $sql =$mysqli->query("SELECT * FROM users ORDER BY nama ASC")or die($mysqli->error);
            }
        }
        else{
            $sql =$mysqli->query("SELECT * FROM users ORDER BY waktu DESC")or die($mysqli->error);
        }
    $cek = $sql->num_rows;
   ...
   if($cek < 1) {
    ...
    ?>
             ...
             <a style="background-color: green;border-color: green; " href="?tampil=lihat-artikel&id=<?php echo $data['id']; ?>" class="btn btn-danger btn-sm"> Lihat </a>
