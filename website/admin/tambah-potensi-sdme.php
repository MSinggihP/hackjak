<?php   
    ...
    {   date_default_timezone_set("Asia/Jakarta");
        ...
        $mysqli->query("INSERT INTO potensi set
            ...
            ") or die($mysqli->error);
        $tambah = true;
        echo"<meta http-equiv='refresh' content='1; url=?tampil=potensi-sdme-posts'>";
    }
    }
 ?>
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Buat Potensi Sumber Daya Manusia
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li>
                                <i class="fa fa-edit"></i>  <a href="?tampil=potensi-sdme-posts">Potensi</a>
                            </li>
                            <li class="active">
