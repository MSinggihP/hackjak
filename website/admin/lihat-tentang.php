<?php   
    ...
    $post = $mysqli->query("SELECT * from profil where id='$_GET[id]'");
...
<div id="page-wrapper">
    ...
    ?>  
                <div class="row">
                    <div class="col-lg-10">
     <form method="post" enctype="multipart/form-data" class="form-horizontal" action="?tampil=edit-tentang&id=<?php echo $lihat['id']; ?>">
