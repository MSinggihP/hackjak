        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            <i class="fa fa-medkit"></i> Puskesmas <small>DKI Jakarta</small>
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                           <button class="btn btn-default"><i class="fa fa-refresh"></i> Update Data</button>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-medkit fa-fw"></i> Data Panel</h3>
                            </div>
   ...
   if($cek < 1) {
    ...
    <?php
        ...
        while($data=$sql->fetch_array()){
            $sql_kelurahan =$mysqli->query("SELECT * FROM kelurahan where kode_kecamatan='$data[features_properties_kode_kecamatan]'")or die($mysqli->error);
            $data_kelurahan   = $sql_kelurahan->fetch_array();
            if($data['features_properties_nama_Puskesmas']!=null){

            
    ?>
                                            
                                            <tr><td><?php echo $no; ?></td>
                                                <td><?php echo $data['features_properties_nama_Puskesmas']; ?></td>
                                                <td><?php echo $data['features_properties_location_alamat']; ?></td>
                                                <td><?php echo $data_kelurahan['nama_kelurahan']; ?></td>
                                                <td><?php echo $data_kelurahan['nama_kecamatan']; ?></td>
                                                <td><?php echo $data_kelurahan['nama_kota']; ?></td>
                                                <td>
