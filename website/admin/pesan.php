 ...
 ?>       
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-money fa-fw"></i> Pesan Panel</h3>
                            </div>
   ...
   if($cari) {
        // jika kotak pencarian tidak sama dengan kosong
            if($input_cari != "") {
                $sql =$mysqli->query("SELECT * FROM pesan where 
                nama like '%$input_cari%' OR 
                tanggal like '%$input_cari%'
                ORDER BY tanggal DESC")or die($mysqli->error);
                } 
            else{
                    $sql =$mysqli->query("SELECT * FROM pesan where 
                nama like '%$input_cari%' OR 
   ...
   if($cek < 1) {
    ...
    ?>
             ...
             <a style="background-color: green;border-color: green; " href="?tampil=lihat-pesan&id=<?php echo $data['id']; ?>" class="btn btn-danger btn-sm"> Lihat </a>
