<?php   
    ...
    { 
        ...
        $tambah = true;
        echo"<meta http-equiv='refresh' content='1; url=?tampil=lihat-slider-post&id=$lihat[id]'>";
    }
    }
 ?>
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-warning alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i> Artikel sedang diedit. <strong>Silakan Tunggu... </strong>
                        </div>
                    </div>
                </div>
                <?php } ?>
    ...
    <tr>
        ...
        <td> <input value="<?php echo $lihat['nama']; ?>" class="form-control" type="text" name="judul" placeholder="Judul" /></td>
    </tr>
    ...
    <tr>
        ...
        <td><textarea  value="" name="detail" class="form-control" rows="3"><?php echo $lihat['detail']; ?></textarea></td>
    </tr>
