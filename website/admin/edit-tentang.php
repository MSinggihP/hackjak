<?php   
    ...
    {   date_default_timezone_set("Asia/Jakarta");
        ...
        if(!isset($errMSG))
        {
        $mysqli->query("UPDATE profil set
                judul = '$_POST[judul]',
                gambar = '$userpic',
                isi = '$_POST[isi]'
            where id='$_GET[id]' ") or die($mysqli->error);
        $tambah = true;
        echo"<meta http-equiv='refresh' content='1; url=?tampil=lihat-tentang-new&id=$lihat[id]'>";
    }
    }
 ?>
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-warning alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i> Profil sedang diedit. <strong>Silakan Tunggu... </strong>
                        </div>
                    </div>
                </div>
                <?php } ?>
