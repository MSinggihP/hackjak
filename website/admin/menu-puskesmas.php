   ...
   ?>    
    <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin.php">Puskesmas Digital</a>
            </div>
            <!-- Top Menu Items -->
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="?tampil=profil"><i class="fa fa-fw fa-user"></i> Profile</a>
                        </li>
                       <!-- <li>
                        ...
                        <li class="divider"></li>
                        <li>
                            <a href="?tampil=keluar"><i class="fa fa-fw fa-power-off"></i> Log Out</a>
                        </li>
                    </ul>
                </li>
            </ul>