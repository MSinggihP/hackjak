<?php   
    ...
    {   date_default_timezone_set("Asia/Jakarta");
        ...
        $tambah = true;
        echo"<meta http-equiv='refresh' content='1; url=?tampil=potensi-sda-update&id=$lihat[id]'>";
    }
    }
 ?>
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-edit"></i>  <a href="?tampil=potensi-desa">Potensi SDA</a>
                            </li>
                            <li class="active">
