<?php   
    ...
    $post = $mysqli->query("SELECT * from potensi where id='$_GET[id]' AND type='sdm'");
...
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <i class="fa fa-edit"></i> Potensi SDM
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    ?>  
                <div class="row">
                    <div class="col-lg-10">
     <form method="post" enctype="multipart/form-data" class="form-horizontal" action="?tampil=edit-potensi-sdme&id=<?php echo $lihat['id']; ?>">
