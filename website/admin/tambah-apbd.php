<?php   
    ...
    {   date_default_timezone_set("Asia/Jakarta");
        ...
        if(!isset($errMSG))
        {
        $mysqli->query("INSERT INTO apbd set
                judul = '$_POST[judul]',
                gambar = '$userpic',
                isi = '$_POST[isi]',
                type='$_GET[type]'
            ") or die($mysqli->error);
        $tambah = true;
        echo"<meta http-equiv='refresh' content='1; url=?tampil=apbd-posts&type=$_GET[type]'>";
    }
    }
 ?>
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li>
                                <i class="fa fa-edit"></i>  <a href="?tampil=potensi-desa-posts">Posts</a>
                            </li>
                            <li class="active">
