<?php   
    ...
    {   date_default_timezone_set("Asia/Jakarta");
        ...
        if(!isset($errMSG))
        {
        $mysqli->query("UPDATE potensi set
                judul = '$_POST[judul]',
                gambar = '$userpic',
                isi = '$_POST[isi]'
            where id='$_GET[id]' ") or die($mysqli->error);
        $tambah = true;
        echo"<meta http-equiv='refresh' content='1; url=?tampil=potensi-sdme-update&id=$lihat[id]'>";
    }
    }
 ?>
<div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Edit Potensi Sumber Daya Manusia
                        </h1>
                        <ol class="breadcrumb">
                            <li>
                            ...
                            <li>
                                <i class="fa fa-edit"></i>  <a href="?tampil=potensi-desa">Potensi SDM</a>
                            </li>
                            <li class="active">
