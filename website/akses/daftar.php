...
ajaxRequest.send(null);
  ...
  <body style="margin:0px;padding:0px;border:0px;background-color: #333333;">
    <div style="" class="container-fluid">
      <div class="col-xs-12 col-md-4 col-md-offset-4" id="form-login" style="margin-top:5px"">
          <form class="form-signin" style="padding: 30px; margin-top:0px" method="post" action="">
          ...
          <h1 style="font-family: 'Raleway', sans-serif; color:#9e9e9e;font-size: 30px;text-align: center;"> Daftar <a style="color:#000; " href="index.php">
          ...
          <div class="form-group form-group-lg has-feedback">
             ...
             <input style="border-radius: 0px;font-family: 'Raleway', sans-serif;" class="form-control" placeholder="Nama Lengkap" name="nama" id="nama" type="text" required>
          </div> 
          <p><span id="txtHint"></span></p>
          <div class="form-group form-group-lg has-feedback">
             <span class="icons glyphicon glyphicon-user form-control-feedback"></span>
             <input onkeyup="showHint(this.value)" style="border-radius: 0px;font-family: 'Raleway', sans-serif;"" class="form-control" placeholder="Username" name="username" id="username" type="text" required>
          </div> 

          <div class="form-group form-group-lg has-feedback">
              <span  class="icons glyphicon glyphicon-lock form-control-feedback"></span>
              <input onkeyup="validasi(event,1)" id='pass' style="border-radius: 0px;font-family: 'Raleway', sans-serif;"" class="form-control" placeholder="Password" name="pass" type="password" required>            
          </div> 
           <p><span id="cocok"></span></p>
          <div class="form-group form-group-lg has-feedback">
              <span  class="icons glyphicon glyphicon-lock form-control-feedback"></span>
              <input style="border-radius: 0px;font-family: 'Raleway', sans-serif;""  onkeyup="validasi(event,2)" class="form-control" placeholder="Konfirmasi Password" name="password2" id="password2" type="password" required>            
          </div> 
          <hr />
          <div class="form-group">
              <button name="btnDaftar" type="submit" class="btn btn-lg btn-block btn-default" style="background-color:#4db6ac;color:white;" >
                <span class="glyphicon glyphicon-log-in"></span> Daftar 
            </button> 
          </div> 
          <div><p style="color:#333333; font-family: 'Raleway', sans-serif;">Sudah punya akun ? <a style="color:#26a69a" href="login.php">Masuk</a></p></div>
